...
While **system-agnostic** (supporting core Foundry rolls on any d20-based system), `pp-dice` is **tested on Pathfinder 2e** and features deep, dedicated integration (Party sheet detection, Fortune & Misfortune traits, and degree of success automation).
...
> 🎲 **System Compatibility**: System-agnostic for d20 rolls — **tested on Pathfinder 2e**.
